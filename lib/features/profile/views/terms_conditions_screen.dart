// lib/features/profile/views/terms_conditions_screen.dart
...
class TermsConditionsScreen extends GetView<StaticPageController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Terms & Conditions'), // Title is static
